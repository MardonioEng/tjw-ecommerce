			...
			<div class="row">
				<div class="col-md-8">
					...
					<c:forEach items="${listaProdutos}" var="produto">
						<div class="col-md-4 items-produto">
							<img src="${produto.getImagem() }" class="img-responsive"><br>
							<div class="text-center">
								<a style="color: black;"><c:out value="${produto.getNome()}"></c:out></a>
							</div>
							<p style="text-align: center;">
								R&#36;
								<c:out value="${ produto.getValor() }"></c:out>
							</p>
							<div class="text-center">
								<a class="button-comprar"
									href="Controller?page=addtocart&id=<c:out value="${produto.getId()}"/>">Comprar</a>
							</div>
							<br>
						</div>
					</c:forEach>
