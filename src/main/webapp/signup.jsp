...
<body>
	...
	<form method="post" action="Controller">
		...
		<div class="signup-group">
			<!-- <label>Senha</label> -->
			<input type="password" name="senha_1" placeholder="Entre com a senha"
				required>
		</div>
		<div class="signup-group">
			<!-- <label>Confirme a senha</label> -->
			<input type="password" name="confirmacao_senha_1"
		...
		<p style="text-align: center; padding-top: 1em;">
			Já possui cadastro? <a href="Controller?page=login"
				style="font-weight: bold; text-decoration: underline;">Entrar!</a>
		</p>
	</form>
	<br>
	<br>
