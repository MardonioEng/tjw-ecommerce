		...
		<c:forEach items="${listaCarrinho }" var="i">
			...
			<table style="table-layout: fixed;width: 100%;">
				<tr>
					...
					<td style="width: 50px; text-align: center;"><c:out value="${produto.getValor()}"/></td>
<%-- 					<td style="width: 100px;"><c:out value="${Product.getCategory()}"/></td> --%>
	...
	<h4 style="margin-top: 40px;margin-bottom: 40px;">Valor Total: R&#36; <c:out value="${ total}"></c:out></h4>
